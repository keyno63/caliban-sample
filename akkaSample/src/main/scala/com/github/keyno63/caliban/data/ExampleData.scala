package com.github.keyno63.caliban.data

import com.github.keyno63.caliban.data.ExampleData.Origin.{ BELT, EARTH, MARS }
import com.github.keyno63.caliban.data.ExampleData.Role.{ Captain, Engineer, Mechanic, Pilot }
